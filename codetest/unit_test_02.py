...
class SupportTest2(unittest.TestCase):
    ...
    def test_check_number_03(self):
        func = Function()
        self.assertEqual(self.func.check_number('-123.45'), False)
    ...
    def test_db_query_all_01(self):
        ...
        self.assertEqual(result, (('adminx', 'admin123'), ('lm', 'lm123')), '测试数据库query_all方法失败.')
